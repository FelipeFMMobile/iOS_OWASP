...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "iOSOwaspSec")
        if inMemory {
        ...
        ValueTransformer.setValueTransformer(SecureTransformer(), forName: NSValueTransformerName("SecureTransformer"))
    }
}
